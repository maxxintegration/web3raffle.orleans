...
public class BeginRaffleEndpoint : Endpoint<RaffleQueryModel, EmptyResponse>
{
	private readonly IClusterClient orleansClient;

	public BeginRaffleEndpoint(IClusterClient orleansClient)
	{
	...
	{
		this.Delete("/raffles/{raffleId}/begin");
		//this.AllowAnonymous();
		this.Roles("Admin");
	...
	public override async Task HandleAsync(RaffleQueryModel req, CancellationToken ct)
	{
		...
		await grain.BeginRaffleAsync(req.RaffleId, ct.ToGrainCancellationToken());
