...
public class DeleteRaffleBlacklistEndpoint : Endpoint<Web3RaffleBlacklistRequestModel, EmptyResponse>
{
	private readonly IClusterClient orleansClient;

	public DeleteRaffleBlacklistEndpoint(IClusterClient orleansClient)
	{
	...
	{
		this.Delete("/raffles/{raffleId}/blacklist");
		//this.AllowAnonymous();
		this.Roles("Admin");
	...
	public override async Task HandleAsync(Web3RaffleBlacklistRequestModel req, CancellationToken ct)
	{
		...
		req.Data = await grain.GetBlacklistAsync(req.RaffleId, ct.ToGrainCancellationToken());
