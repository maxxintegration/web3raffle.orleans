...
public class DownloadRaffleWinnersEndpoint : Endpoint<IdRequestModel>
{
	private readonly IClusterClient orleansClient;

	public DownloadRaffleWinnersEndpoint(IClusterClient orleansClient)
	{
	...
	{
		this.Get("/raffles/{raffleId}/winners/download");
		this.AllowAnonymous();
	...
	public override async Task HandleAsync(IdRequestModel req, CancellationToken ct)
	{
		...
		var fileBytes = await grain.DownloadWinnersAsync(req.RaffleId, ct.ToGrainCancellationToken());
